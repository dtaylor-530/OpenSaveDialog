...
namespace OpenSave.Wpf
{
    ...
    public class OpenSaveEditorControl : Control, Contracts.IPath
    {
        ...
        private void OpenSaveControl_FileObjectChanged(object sender, WPFUtility.ObjectChangeEventArgs e)
        {
            var xx = ObjectConverter == null
                         ? (e as WPFUtility.ObjectChangeEventArgs).Object
        ...
        public WPFUtility.Contracts.IObjectChangeEventCommand Content
        {
            get { return (WPFUtility.Contracts.IObjectChangeEventCommand)GetValue(ContentProperty); }
            set { SetValue(ContentProperty, value); }
        }

        public static readonly DependencyProperty ContentProperty = DependencyProperty.Register("Content", typeof(WPFUtility.Contracts.IObjectChangeEventCommand), typeof(OpenSaveEditorControl), new PropertyMetadata(null, Changed));

        private static void Changed(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            WPFUtility.Contracts.IObjectChangeEvent objectEvent = e.NewValue as WPFUtility.Contracts.IObjectChangeEvent;

            objectEvent.ObjectChange += (t, s) =>
                {
                    var xx = (d as OpenSaveEditorControl).ObjectConverter == null
                                 ? (s as WPFUtility.ObjectChangeEventArgs).Object
                                 : (d as OpenSaveEditorControl).ObjectConverter.Convert((s as WPFUtility.ObjectChangeEventArgs).Object, null, null, null);
