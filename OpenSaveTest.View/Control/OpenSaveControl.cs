...
namespace OpenSave.Wpf
{
    ...
    public class OpenSaveControl : ButtonsBase, IFileObject, ICanLoad, ICanSave, IObjectChangeEvent //, ISave
    {
        ...
        public static readonly RoutedEvent ObjectChangeEvent = EventManager.RegisterRoutedEvent("ObjectChange", RoutingStrategy.Bubble, typeof(RoutedObjectChangeEventHandler), typeof(OpenSaveControl));
        ...
        {
            RoutedEventArgs newEventArgs = new ObjectChangeEventArgs(OpenSaveControl.ObjectChangeEvent,  this.FileObject);
        ...
        public delegate void RoutedObjectChangeEventHandler(object x, ObjectChangeEventArgs objectChangeEventArgs);
